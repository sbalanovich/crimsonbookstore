...
$(document).ready(function()
{
    ...
    //makes sure that the username being sent to is valid
...
<form action="sendpm.php" method="post">
        ...
        <div id="centercontent" class="hero-unit" style="color:#FFFFFF">
            ...
            <h4>To User:</h4> 
                    <input class="input" id="to_user" type="text" name="to_user" maxlength="32" value = "">
                    <p><span id="msgbox" style="display:none"></span></p>
            <br/>
            <h4>Message:</h4> 
                   <TEXTAREA NAME="message" COLS="100" ROWS=10 WRAP=SOFT></TEXTAREA>
            <p>
